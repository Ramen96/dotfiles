...
# 1) Packages
1. ```
   sudo pacman -S zsh fastfetch dosfstools htop unzip waybar libsecret qt5-wayland qt6-wayland gnome-keyring libgnome-keyring vim nwg-look hyprland hyprpaper hypridle hyprlock kvantum nerd-fonts steam gamescope discord libreoffice-still dolphin wofi kitty ghostty
   ```
2. ```
