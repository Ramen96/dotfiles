...
-- Handle runtime errors after startuprun prompt
do
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "p", function () awful.spawn.with_shell("~/.config/picom/script/toggle_picom.sh") end,
    ...
    end, {description = "show rofi with drun", group = "launcher"})
)
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "m",
        ...
        {description = "(un)maximize all windows", group = "client"}),
